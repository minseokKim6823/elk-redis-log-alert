...
- Prometheus: http://localhost:9090 (Spring Boot ��Ʈ�� `/actuator/prometheus` ��ũ��). Grafana ������ �ҽ� URL�� `http://prometheus:9090`.
- Grafana: http://localhost:3000 (�⺻ `admin/admin`). Prometheus�� Loki�� ������ �ҽ��� �߰� �� ���ϴ� ��ú���/�α� �г� ����.
- Loki: http://localhost:3100 (`http://loki:3100`���� Grafana ���� ����). �⺻ �α� �� `{job="spring-app", app="elk-alert-system"}`.
- Promtail: ȣ��Ʈ `./logs` ���͸��� `/var/log/app`���� ����Ʈ�Ͽ� RollingFileAppender �α�(`logs/app.log`)�� Loki�� ����.
- Spring Boot ��Ʈ�� ��������Ʈ: http://localhost:8080/actuator/prometheus
